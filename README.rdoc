...
This is the code
- @bookings = (Booking.search filter:{or:[{range:{number_of_guests:{gte: params[:booking][:number_of_guests]}}},
              {range:{number_of_guests:{lt: params[:booking][:number_of_guests]}}}]},size:2001, sort:{room_id:{order: "asc"}}).records.to_a
